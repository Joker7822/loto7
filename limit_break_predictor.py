...
class LimitBreakPredictor:
    ...
    def limit_break_predict(
        ...
        ga_pop_size: int = 160,
        sampler_n: int = 120, target_date: Optional[pd.Timestamp] = None,
    ) -> List[PredWithScore]:
        ...
        history_df = latest_data[latest_data["抽せん日"] < target_date] if target_date is not None else latest_dataif history_df.empty:
